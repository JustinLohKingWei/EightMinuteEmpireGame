...
int main()
{
    ...
    game_map* world_map = new game_map("Everything");
    world_map->m_map.insert(tile1->m_map.begin(), tile1->m_map.end());
    world_map->m_map.insert(tile2->m_map.begin(), tile2->m_map.end());
    world_map->m_map.insert(tile3->m_map.begin(), tile3->m_map.end());
    world_map->m_map.insert(tile4->m_map.begin(), tile4->m_map.end());
